...
# More suitable stats by SpeciesK
...
In the above example, each species is differentiated by shape of the point. But we don't see any legend to indicate which shape represents which species. Try the following as arguments to `geom_point()`:
